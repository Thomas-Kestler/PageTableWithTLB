...
//Thomas Kestler 
//file provided by SDSU and includes minimal modifications by myself. I did not originally create this file
/*
 * Compilation notes:
 * C compilers:
...
//void hexnumNoNL(uint32_t number);//variant of hexnum that doesn't print a new line character, might be used for vpn2pfn
